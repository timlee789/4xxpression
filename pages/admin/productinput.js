...
export default function AdminProductScreen() {
    ...
    const submitHandler = async({ productname, price, description1, description2, image}) => {
        try {
     ...
     <h1 className="mb-4 text-xl">Product Registration</h1>
            ...
            <form className='mx-auto max-w-screen-md'
                ...
                <div className='mb-4'>
                    ...
                    <input type="text"
                    {...register('productname',{required: 'Please enter productname', 
                })}
                    className="w-full" id="productname" autoFocus></input>
                    {errors.productname && (
                ...
                <div className='mb-4'>
                    ...
                    className="w-full" id="price"></input>
                    {errors.price && (
                ...
                <div className='mb-4'>
                    ...
                    <input type="text" 
                    {...register('description1',{required: 'Please enter description1', 
                    
                })}
                    className="w-full" id="description1" autoFocus></input>
                    {errors.description1 && (<div className='text-red-500'> {errors.description1.message}</div>)}
                </div>

                <div className='mb-4'>
                    <label htmlFor='description2'>description2</label>
                    <input type="text" 
                    {...register('description2',{required: 'Please enter description2', 
                   
                })}
                    className="w-full" id="description2" autoFocus></input>
                    {errors.description2 && (<div className='text-red-500'> {errors.description2.message}</div>)}
                ...
                <div className='mb-4'>
                    ...
                    className="w-full" id="image" autoFocus></input>
              ...
              <tbody key={index} >
                {order.product.map((subcam, i) => (
                  <tr key={i} className="border-b">
                    ...
                    <td className=" p-5 "><Image src={subcam.image} alt={subcam.productname} width={150} height={150}/></td>
                    <td className='p-5'>  
